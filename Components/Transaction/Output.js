...
export default class Output extends Component {
    ...
    await axios.get(`https://blockchain.info/q/txtotbhfhgalbtcoutput/${this.state.address}`)
        .then((res)=>
        {
            this.setState({output:(res.data)*10**18, outputmodal:true})
  ...
  render() {
    return (
        <SafeAreaView style={styles.container}>
            ...
            <Modal
                transparent={true}
                visible={this.state.outputmodal}
            //    visible={true}
              >
                <View style={styles.modalView1}>
                    <View style={styles.div2}>
                        ...
                        <View style={styles.btnView}>
                            <TouchableOpacity style={styles.modalbtn} onPress={()=>{this.setState({outputmodal:false})}}>
