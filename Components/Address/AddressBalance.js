...
export default class AddressBalance extends Component {



    Getbalance=async()=>{
        await axios.get(`https://blockchain.info/q/adddressbalance/${this.state.address}`)
        .then((res)=>{
            this.setState({balance:(res.data)*10**18, balancemodal:true})
        })
    }
    ...
    return (
        <SafeAreaView style={styles.container}>
            <View style={styles.div1}>
                ...
                <View>
                    <TouchableOpacity style={styles.button} onPress={()=>{this.Getbalance()}}>
