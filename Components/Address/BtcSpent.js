...
export default class BtcSpent extends Component {
    ...
    Getspent=async()=>{
        ...
        .then((res)=>
        {
            this.setState({spent:(res.data)*10**18, spentmodal:true})
        })
    }
    ...
    return (
        <SafeAreaView style={styles.container}>
            <View style={styles.div1}>
                ...
                <View>
                    <TouchableOpacity style={styles.button} onPress={()=>{this.Getspent()}}>
            ...
            <Modal
                transparent={true}
                visible={this.state.spentmodal}
            >
                <View style={styles.modalView1}>
                    <View style={styles.div2}>

                        <View style={styles.btnView}>
                            <TouchableOpacity style={styles.modalbtn} onPress={()=>{this.setState({spentmodal:false})}}>
                                <Text style={styles.modalbtntxt}>X</Text>
                            </TouchableOpacity>
                        </View>
                        
                        <View>
                            <Text style={styles.btctext}>Total BTC Spent:  {parseInt(this.state.spent).toFixed(3)} BTC</Text>
                        </View>
                    </View>
